        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            */
            ...
            if (F == "KY-T1HIST")
            {
                ...
                HyperLink hyl_Air_1 = (HyperLink)FindControl("factory_KY_Air_1");
                hyl_Air_1.Visible = true;
                HyperLink hyl_Air_2 = (HyperLink)FindControl("factory_KY_Air_2");
                hyl_Air_2.Visible = true;
                ...
                hyl_PV.Visible = true;
                HyperLink hyl_cycle_1 = (HyperLink)FindControl("factory_KY_cycle_1");
                hyl_cycle_1.Visible = true;
                HyperLink hyl_cycle_3 = (HyperLink)FindControl("factory_KY_cycle_3");
                hyl_cycle_3.Visible = true;
                HyperLink hyl_cycle_5 = (HyperLink)FindControl("factory_KY_cycle_5");
                hyl_cycle_5.Visible = true;
            }
            else if (F == "BL-T1HIST")
            {
                ...
                hyl_Mill_3.Visible = true;
                HyperLink hyl_cycle_1 = (HyperLink)FindControl("factory_BL_cycle_1");
                hyl_cycle_1.Visible = true;
                HyperLink hyl_cycle_3 = (HyperLink)FindControl("factory_BL_cycle_3");
                hyl_cycle_3.Visible = true;
            }
            else if (F == "QX-T1HIST")
            {
                ...
                hyl_Mill_3.Visible = true;
                HyperLink hyl_cycle_1 = (HyperLink)FindControl("factory_QX_cycle_1");
                hyl_cycle_1.Visible = true;
                HyperLink hyl_cycle_3 = (HyperLink)FindControl("factory_QX_cycle_3");
                hyl_cycle_3.Visible = true;
            }
            else if (F == "ZB-T1HIST")
            {
                ...
                hyl_Air.Visible = true;
                HyperLink hyl_Air_1 = (HyperLink)FindControl("factory_ZB_Air_1");
                hyl_Air_1.Visible = true;
                HyperLink hyl_Air_4 = (HyperLink)FindControl("factory_ZB_Air_4");
                hyl_Air_4.Visible = true;
                ...
                HyperLink hyl_cycle_1 = (HyperLink)FindControl("factory_ZB_cycle_1");
                hyl_cycle_1.Visible = true;
                HyperLink hyl_cycle_3 = (HyperLink)FindControl("factory_ZB_cycle_3");
                hyl_cycle_3.Visible = true;
                HyperLink hyl_cycle_5 = (HyperLink)FindControl("factory_ZB_cycle_5");
                hyl_cycle_5.Visible = true;
                HyperLink hyl_cycle_7 = (HyperLink)FindControl("factory_ZB_cycle_7");
                hyl_cycle_7.Visible = true;
            }
            else if (F == "KH-PCC-LH")
            {
                ...
                HyperLink hyl_cycle_1 = (HyperLink)FindControl("factory_KH_cycle");
                hyl_cycle_1.Visible = true;
            }
            else if (F == "LD-T1HIST")
            {
                ...
                HyperLink hyl_cycle_1 = (HyperLink)FindControl("factory_LD_cycle_1");
                hyl_cycle_1.Visible = true;
                HyperLink hyl_cycle_2 = (HyperLink)FindControl("factory_LD_cycle_2");
                hyl_cycle_2.Visible = true;
            }
            else if (F == "LZ-T1HIST")
            {
                ...
                hyl_PV.Visible = true;
                HyperLink hyl_cycle_1 = (HyperLink)FindControl("factory_LZ_cycle");
                hyl_cycle_1.Visible = true;
            }
            else if (F == "HL-T1HIST")
            {
                ...
                hyl_Mill.Visible = true;
                HyperLink hyl_cycle_1 = (HyperLink)FindControl("factory_HL_cycle");
                hyl_cycle_1.Visible = true;
            }
            else if (F == "XG-T1HIST")
            {
